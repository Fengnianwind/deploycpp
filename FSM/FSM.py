...
from policy.beyond_mimic2.BeyondMimic2 import BeyondMimic2
...
class FSM:
    def __init__(self, state_cmd:StateAndCmd, policy_output:PolicyOutput):
        ...
        self.beyond_mimic_policy2 = BeyondMimic2(state_cmd, policy_output)
        self.anyadapter_policy = AnyAdapter(state_cmd, policy_output)
    ...
    def get_next_policy(self, policy_name:FSMStateName):
        ...
        elif((policy_name == FSMStateName.SKILL_BEYOND_MIMIC2)):
            self.cur_policy = self.beyond_mimic_policy2
        elif((policy_name == FSMStateName.SKILL_ANYADAPTER)):
            self.cur_policy = self.anyadapter_policy
        else:
            pass
